...
MOTION_DIR = (
    "media/qtl"  # Default= "media/motion"  Folder Path for Motion Detect Image Storage
)
MOTION_RECENT_DIR = (
    "media/recent/qtl"  # Default= "media/recent/motion"  Location of motionRecent files
)
...
MOTION_TRACK_MINI_TL_TIMER_SEC = (
    0  # Default= 5 seconds between each Quick time lapse image. 0 is fast as possible
)
