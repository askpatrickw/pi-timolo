...
MOTION_DIR = (
    "media/shop"  # Default= "media/motion"  Folder Path for Motion Detect Image Storage
)
...
MOTION_TRACK_MINI_TL_TIMER_SEC = (
    20  # Default= 5 seconds between each Quick time lapse image. 0 is fast as possible
)
